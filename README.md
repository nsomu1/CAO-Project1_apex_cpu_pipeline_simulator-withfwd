...
For all Cycles display:
 ./apex_sim input.asm display

For simulating few cycles:
 ./apex_sim input.asm simulate <no. of cycles>

For the value of a memory location:
 ./apex_sim input.asm showmem <memory location>
